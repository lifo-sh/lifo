...
- 4c3257c: Preview router shim: never treat a blob URL's own uuid as the current route.
  ...
  uuid belonging to the _previous_ mount, and only a full page reload cleared it.

    ...
    <ProjectExample
      ...
      subtitle={
        <>
          ...
          <code>npm install</code>, start the backend with <code>npm run backend &amp;</code>, then{' '}
          <code>npm start</code>. The <b>App</b> tab shows the React Native web app (Metro + Fast
          Refresh); the <b>Studio</b> tab is tinbase&apos;s admin dashboard — paste the{' '}
          <code>service_role</code> key printed in the terminal to browse the todos table, run SQL,
          and watch logs.
        </>
      }
